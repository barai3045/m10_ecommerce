...
CREATE TABLE `product_details` (
    ...
    UNIQUE INDEX `product_details_prduct_id_key`(`prduct_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `product_sliders` (
    ...
    UNIQUE INDEX `product_sliders_prduct_id_key`(`prduct_id`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `product_reviews` (
    ...
    UNIQUE INDEX `product_reviews_customer_id_key`(`customer_id`),
...
CREATE TABLE `invoices` (
    ...
    `delivary_status` ENUM('Pending', 'Processing', 'Completed') NOT NULL,
...
CREATE TABLE `policies` (
    `id` INTEGER NOT NULL AUTO_INCREMENT,
    `type` ENUM('about', 'refund', 'contact', 'complain') NOT NULL,
    `des` LONGTEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE `product_details` ADD CONSTRAINT `product_details_prduct_id_fkey` FOREIGN KEY (`prduct_id`) REFERENCES `products`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `product_sliders` ADD CONSTRAINT `product_sliders_prduct_id_fkey` FOREIGN KEY (`prduct_id`) REFERENCES `products`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
