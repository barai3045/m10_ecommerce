                ...
                <div className="container py-5">
                    <div className="row">
                        <div className="col-md-4">
                            ...
                            <p className="my-2">
                                <Link className="nav-link" href="/legals/terms">Terms</Link>
                            </p>
                        </div>
                        <div className="col-md-4">
                            <h1 className="bodyMedium">Information</h1>
                            <p className="my-2">
                                <Link className="nav-link" href="/legals/buy">How to buy</Link>
                            </p>
                            <p className="my-2">
                                <Link className="nav-link" href="/legals/contact">Contact</Link>
                            </p>
                            <p className="my-2">
                                <Link className="nav-link" href="/legals/complain">Complain</Link>
                            </p>
                        </div>
                        <div className="col-md-4">
